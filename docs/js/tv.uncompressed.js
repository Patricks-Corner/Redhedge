...
var span = document.getElementsByClassName("close")[0];
	...
	$.getJSON(url, function(deeta) {
			...
			$.each(deeta.seasons, function(i, data) {
				...
				season_img += ("<img onclick=\"episodeinfo("+data.season_number+")\" src=\"https://image.tmdb.org/t/p/w185/"+ data.poster_path +"\">");
...
$.get( proxy+"https://videospider.in/getticket.php?key=JhhbVDPq3GIdkhuE&secret_key=a10ro5sbabnvycg0dfn1dn1h7h26bn&video_id="+window.idtv+"&tmbd=1&s="+window.season+"&ip="+clientIP+"", function( data ) {
